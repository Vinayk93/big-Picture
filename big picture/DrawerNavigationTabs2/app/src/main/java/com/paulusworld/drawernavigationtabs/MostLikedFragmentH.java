...
public class MostLikedFragmentH extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.v(TAG, "List View Item: " + "h mostliked selected");


       View rootView = inflater.inflate(R.layout.fragment_hmostliked, container, Boolean.parseBoolean(null));
