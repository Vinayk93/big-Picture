...
public class MostLikedFragmentT extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.v(TAG, "List View Item: " + "tmostliked selected");

        View rootView = inflater.inflate(R.layout.fragment_tmostliked, container, Boolean.parseBoolean(null));
